...
export default function Profile() {
  ...
  const [updateSuccess, setUpdateSucesss] = useState(false);
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      <h1 
        className='text-3xl font-semibold text-center my-7'>Profile
      </h1>
      ...
      <p className='text-red-700 mt-5'>{showListingError ? "Error in showing Listings" : ""}</p>
